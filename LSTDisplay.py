...
class LSTDisplay:
    ...
    def __init__(self, det_geom):
        ...
        self.centroidDB = Centroid("data/sensor_centroids.txt")
    ...
    def display_centroid_xy(self):
        ...
        f = open("data/sensor_centroids.txt")
        lines = f.readlines()
...
def getDefaultLSTDisplay():
    ...
    det_geom = DetectorGeometry("data/sensor_corners.txt", "data/average_radius.txt", "data/average_z.txt")
...
def test3():
    ...
    from Centroid import Centroid
    centroidDB = Centroid("data/sensor_centroids.txt")
    ...
    # list_of_detids_etaphi_layer1 = det_geom.getDetIds(lambda x: Module(x[0]).subdet() == 5 and Module(x[0]).side() == 3 and Module(x[0]).layer() == 1)
    # list_of_detids_etaphi_layer2 = det_geom.getDetIds(lambda x: Module(x[0]).subdet() == 5 and Module(x[0]).side() == 3 and Module(x[0]).layer() == 2)
    # list_of_detids_etaphi_layer3 = det_geom.getDetIds(lambda x: Module(x[0]).subdet() == 5 and Module(x[0]).side() == 3 and Module(x[0]).layer() == 3)
    # list_of_detids_etaphi_layer4 = det_geom.getDetIds(lambda x: Module(x[0]).subdet() == 5 and Module(x[0]).side() == 3 and Module(x[0]).layer() == 4)
    # list_of_detids_etaphi_layer5 = det_geom.getDetIds(lambda x: Module(x[0]).subdet() == 5 and Module(x[0]).side() == 3 and Module(x[0]).layer() == 5)
    # list_of_detids_etaphi_layer6 = det_geom.getDetIds(lambda x: Module(x[0]).subdet() == 5 and Module(x[0]).side() == 3 and Module(x[0]).layer() == 6)
